    ...
    <section class="presentation-section">
        <div class="presentation-content">
            ...
            <form class="search-form" method="post" action="index.php?p=trajet">
                <input type="text" name="lieu_depart" placeholder="Lieu de départ" value="<?= htmlspecialchars($lieu_depart ?? '') ?>">
                <input type="text" name="lieu_arrivee" placeholder="Destination" value="<?= htmlspecialchars($lieu_arrivee ?? '') ?>">
        ...
        <div class="presentation-content">
            ...
            <section class="filters-bar">
                ...
                <form method="post" action="index.php?p=trajet" id="form-filters" name="filters-form">
                    ...
                    <input type="hidden" name="lieu_depart" value="<?= htmlspecialchars($lieu_depart ?? ''); ?>">
                ...
                <input type="hidden" name="apply_filters" value="1">-->
                        ...
                        <div class="mention-options">
                            <label class="option-item">
                                <input type="checkbox" name="energie[]" value="ecologique"
                                    <?= (isset($filters['energie']) && is_array($filters['energie']) && in_array('ecologique', $filters['energie'])) ? 'checked' : ''; ?>>
                                <span>ÉCO</span>
                            </label>
                            <label class="option-item">
                                <input type="checkbox" name="energie[]" value="standard"
                                    <?= (isset($filters['energie']) && is_array($filters['energie']) && in_array('standard', $filters['energie'])) ? 'checked' : ''; ?>>
                                <span>STD</span>
                            </label>
                        </div>
                    </div>
                    <!-- Prix Min -->
                    <div class="filter-group">
                        <label>PRIX MIN (<span id="label-prix-min"><?= htmlspecialchars($filters['prix_min'] !== '' ? $filters['prix_min'] : '0'); ?></span>€)</label>
                        <input type="range" class="range-slider" name="prix_min" id="prix_min" min="0" max="50" value="<?= htmlspecialchars($filters['prix_min'] !== '' ? $filters['prix_min'] : '0'); ?>">
                        <div class="range-values"><span>0€</span><span>50€</span></div>
                    </div>
                    <!-- Prix Max -->
                    <div class="filter-group">
                        <label>PRIX MAX (<span id="label-prix-max"><?= htmlspecialchars($filters['prix_max'] !== '' ? $filters['prix_max'] : '50'); ?></span>€)</label>
                        <input type="range" class="range-slider" name="prix_max" id="prix_max" min="5" max="100" value="<?= htmlspecialchars($filters['prix_max'] !== '' ? $filters['prix_max'] : '50'); ?>">
                        <div class="range-values"><span>5€</span><span>100€</span></div>
                    </div>
                    <!-- Durée Max -->
                    <div class="filter-group">
                        <label>DURÉE MAX (<span id="label-duree"><?= htmlspecialchars($filters['duree_max'] !== '' ? $filters['duree_max'] : '20'); ?></span>h)</label>
                        <input type="range" class="range-slider" name="duree_max" id="duree_max" min="1" max="20" value="<?= htmlspecialchars($filters['duree_max'] !== '' ? $filters['duree_max'] : '20'); ?>">
                        <div class="range-values"><span>1h</span><span>20h</span></div>
                    </div>
                    <!-- Notes -->
                    <div class="filter-group">
                        <label>NOTES (<span id="label-score"><?= htmlspecialchars($filters['score_min'] !== '' ? $filters['score_min'] : '4'); ?></span>★)</label>
                        <input type="range" class="range-slider" name="score_min" id="score_min" min="1" max="5" step="0.1" value="<?= htmlspecialchars($filters['score_min'] !== '' ? $filters['score_min'] : '4'); ?>">
            ...
            <?php if (empty($trajets)) { ?>
                <div class="trip-list" id="liste-resultats">
                    <div class="alert alert-info">
                        Aucun voyage prévu pour le moment avec les critères sélectionnés.
